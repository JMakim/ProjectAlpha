...
public class Turret : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        upgradeUI.canvas.transform.LookAt(Camera.main.transform);
        upgradeUI.canvas.transform.RotateAround(upgradeUI.canvas.transform.position, upgradeUI.canvas.transform.transform.up, 180);//to reverse the wrong facing angle
    }
